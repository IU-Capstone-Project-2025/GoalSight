    ...
    <div className="bg-gray-800 text-white rounded-lg p-3 md:p-6 shadow-lg flex flex-1 flex-col items-center justify-center border border-red-600 w-full h-full">
        <div className="flex items-center mb-2 md:mb-4">
            ...
            <div className="relative group">
                ...
                <div className="absolute left-8 top-1/2 -translate-y-1/2 w-48 md:w-64 bg-gray-800 text-xs md:text-sm text-white rounded shadow-lg px-2 md:px-4 py-1 md:py-2 border border-gray-400 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-200 z-10">
