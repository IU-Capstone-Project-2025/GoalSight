        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-red-900 to-black rounded-lg p-8 text-center">
              ...
              {loading ? (
                <div className="mx-auto w-64 h-6 bg-gray-600 rounded animate-pulse" />
              ) : nextMatch ? (
                <NextMatchCard
                ...
                <p className="text-gray-400">No next match found</p>
              )}
            </div>
              ...
              {loading ? (
                <div className="space-y-4">
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={i}
                      className="h-24 w-full bg-gray-700 animate-pulse rounded-lg"
                    />
                  ))}
                </div>
              ) : (
